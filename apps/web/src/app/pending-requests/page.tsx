  ...
  const handleAction = async (requestId: string, action: MatchAction) => {
    ...
    try {
      ...
      if (!interactionRecorded) {
        ...
        if (action === "like") {
          setMessage(
            "Match created! You can now connect with this person."
          );
        }
        setTimeout(() => {
          goToNext();
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex items-center space-x-4 text-sm font-mono text-gray-600">
                        {currentRequest.profile?.city_name && currentRequest.profile?.country && (
                          <span>📍 {currentRequest.profile.city_name}, {currentRequest.profile.country}</span>
                        )}
                  ...
                  {!showBlockConfirm ? (
                    <>
                      <div className="flex justify-center space-x-4">
                        <button
                          onClick={() => handleAction(currentRequest.id, "pass")}
                        ...
                        <button
                          onClick={() => handleAction(currentRequest.id, "like")}
                          disabled={isSubmitting}
                    ...
                    <div className="space-y-4">
                      <div className="bg-red-50 p-4 rounded border border-red-200">
                        ...
                        <p className="font-mono text-xs text-red-700">
                          They won't appear in your requests again and you won't see each other.
                        </p>
                      </div>

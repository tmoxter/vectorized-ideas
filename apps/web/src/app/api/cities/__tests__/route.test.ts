...
describe('GET /api/cities', () => {
  ...
  it('should respect limit parameter', async () => {
    ...
    const request = new NextRequest('http://localhost/api/cities?q=san&limit=2');
    const response = await GET(request);
    const data = await response.json();
  ...
  it('should filter by country when provided', async () => {
    ...
    const request = new NextRequest('http://localhost/api/cities?q=san&country=US');
    const response = await GET(request);
  ...
  it('should trim whitespace from query', async () => {
    ...
    const request = new NextRequest('http://localhost/api/cities?q=%20%20san%20%20');
    await GET(request);

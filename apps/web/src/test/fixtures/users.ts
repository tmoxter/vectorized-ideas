...
export const testUsers: TestUser[] = [
  {
    ...
    profile: {
      ...
      achievements:
        "Led engineering team at Series B startup. Built developer platform used by 10k+ engineers.",
    ...
    venture: {
      ...
      description:
        "Building an intelligent code review tool that uses LLMs to provide contextual feedback and catch bugs before they reach production.",
    },
    preferences: {
      user_id: "user-1-test-id",
      title: "Technical Co-founder with Product Sense",
      description:
        "Looking for someone with strong product intuition and experience in developer tools or B2B SaaS.",
    },
    stage: "Ideation",
  ...
  },
  {
    ...
    profile: {
      ...
      achievements:
        "Launched 3 successful features at Google Cloud. Grew user base from 0 to 100k.",
      region: "Austin, TX",
    ...
    venture: {
      ...
      description:
        "Platform to help engineering teams understand their workflow bottlenecks and improve developer experience using data-driven insights.",
    },
    preferences: {
      user_id: "user-2-test-id",
      title: "Technical Co-founder (Backend/Infrastructure)",
      description:
        "Need someone strong in backend systems, data pipelines, and scaling infrastructure.",
    },
    stage: "MVP",
  ...
  },
  {
    ...
    profile: {
      ...
      achievements:
        "Built energy management system that reduced costs by 30%. Published research on smart grid optimization.",
      region: "Seattle, WA",
      timezone: "America/Los_Angeles",
    },
    venture: {
      ...
      description:
        "SaaS platform helping companies measure, track, and reduce their carbon emissions with real-time data and actionable insights.",
    },
    preferences: {
      user_id: "user-3-test-id",
      title: "Business Co-founder with Climate Tech Experience",
      description:
        "Looking for someone with sales/BD experience in enterprise SaaS, ideally with climate tech or sustainability background.",
    },
    stage: "Prototype",
  ...
  },
  {
    ...
    profile: {
      ...
      achievements:
        "Improved recommendation accuracy by 15%. Contributed to open-source ML frameworks.",
      region: "New York, NY",
    ...
    venture: {
      ...
      description:
        "Enabling non-technical users to build and deploy machine learning models without writing code. Think Webflow for ML.",
    },
    preferences: {
      user_id: "user-4-test-id",
      title: "Design-focused Co-founder",
      description:
        "Need someone with exceptional UX/UI skills to make complex ML concepts simple and intuitive.",
    },
    stage: "Ideation",
  ...
  },
  {
    ...
    profile: {
      ...
      achievements:
        "Scaled telemedicine platform to 500k users. HIPAA compliance expert.",
      region: "Boston, MA",
      timezone: "America/New_York",
    },
    venture: {
      ...
      description:
        "Connecting people with licensed therapists through an affordable, accessible platform. Using AI for initial screening and therapist matching.",
    },
    preferences: {
      user_id: "user-5-test-id",
      title: "Healthcare/Medical Professional",
      description:
        "Looking for someone with clinical background or healthcare operations experience to ensure we build something truly helpful.",
    },
    stage: "MVP",
